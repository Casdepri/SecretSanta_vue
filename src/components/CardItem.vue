<template>
    <div class="card-item" @click="openCard(); setHashOnName(participant.name);">
        <div class="card-backside" :class="{ open: setOpenClass }" ref="observer"><img type="image/svg+xml" :src="logo">
        </div>
